...
local Window = Library.CreateLib("ilana's shitty lua", "DarkTheme")
...
MainSection:NewSlider("aimlock Snapping", "Change The rate the aimlock tracks someone", 8, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)

end)

    local MainSection = Main:NewSection("Fov")

MainSection:NewButton("Field of View", "cringe Fov", function()
...
MainSection:NewButton("ESP/WH", "Decentish ESP", function()
...
SettingsSection:NewButton("ilana - the retarded skid dev")
